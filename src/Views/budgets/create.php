<div class="mb-8">
    <h1 class="text-3xl font-bold text-secondary">Nuevo Presupuesto</h1>
    <p class="text-gray-600 mt-2">Crear un presupuesto detallado con cálculo automático de impuestos</p>
</div>

<div class="card p-10 shadow-2xl" x-data="{ 
        items: [{ concept: '', quantity: 1, unit_price: 0, total: 0 }],
        tax_rate: <?= $settings->default_iva_rate ?? 21 ?>,
    ...
    x-init="$watch('items', () => calculateTotals()); $watch('tax_rate', () => calculateTotals()); $watch('irpf_rate', () => calculateTotals()); $watch('has_irpf', () => calculateTotals());">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pb-8 border-b border-gray-100">
            <div class="space-y-6">
                <div>
                    ...
                    <select id="client_id" name="client_id" required class="input-standard">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" required class="input-standard"
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="valid_until" name="valid_until" class="input-standard">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" class="input-standard"></textarea>
                </div>
            </div>
        </div>
                    ...
                    <template x-for="(item, index) in items" :key="index">
                        <div
                            ...
                            <div class="col-span-6">
                                <input type="text" x-model="item.concept"
                            ...
                            <div class="col-span-2">
                                <input type="number" x-model="item.quantity" @input="calculateRow(item)" step="0.01"
                                    class="input-standard text-sm text-right w-full" placeholder="1">
                            </div>

                            <div class="col-span-2">
                                <input type="number" x-model="item.unit_price" @input="calculateRow(item)" step="0.01"
                                    class="input-standard text-sm text-right w-full" placeholder="0.00">
                            </div>
